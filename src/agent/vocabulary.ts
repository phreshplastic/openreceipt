...
export const blockVocabulary: BlockVocabularyEntry[] = [
  ...
  { type: "logo", live: false, whenToUse: "The shop sign at the top of a receipt. One per receipt, first block. Leave the existing one alone unless asked.", needs: "name; tagline?  — always printed in caps, and the mark is the person's own, not yours to pick" },
];
