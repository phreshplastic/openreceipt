...
export function LandingPage({ configured }: { configured: boolean }) {
  ...
  return <main className="landing">
    ...
    <section className="hero">
      ...
      <div className="hero-object" aria-label="Sample thermal receipt"><PaperSurface className="hero-paper"><span className="micro">PETE’S PRINTER</span><strong>THINGS FOR<br />THE MORNING</strong><i /><p><b>□</b> Pack the charger</p><p><b>□</b> Take the blue folder</p><p><b>✓</b> Make coffee</p><i /><small>MADE TO BE USED</small></PaperSurface><div className="hero-shadow" /></div>
    </section>
